...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public DeterministicHierarchy hierarchy;
    ...
    public byte[] getPubKeys(NetworkParameters parameters) {
        return hierarchy.get(getAccountPath(), false, false).serializePublic(parameters);
    }

    public byte[] getPriKeys(NetworkParameters parameters) {
        return hierarchy.get(getAccountPath(), false, true).serializePrivate(parameters);
    }
